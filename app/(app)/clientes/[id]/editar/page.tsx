...
import { ArrowLeft, Save, User, Building2, Plus, Trash2, MapPin, Loader2, Phone, Mail, FileText, Tag } from 'lucide-react'
...
export default function EditarClientePage() {
  ...
  const atualizarContato = (contatoId: string, field: keyof Contato, value: string | boolean) => {
    ...
    setContatos(prev =>
      prev.map(c =>
        c.id === contatoId ? { ...c, [field]: formattedValue } : c
      )
    )
  }
  ...
  return (
    <div className="pb-24 lg:pb-8">
      <Header
        ...
        subtitle={formData.nomeExibicao || 'Carregando...'}
        actions={
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 rounded-lg border outline-none transition-all ${
                      errors.nomeExibicao ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-500/20' : 'border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20'
                    }`}
                ...
                <p className="text-xs text-slate-500 mt-1.5 flex items-center gap-1">
                  ...
                  O identificador é gerado automaticamente a partir do CPF/CNPJ
                </p>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-10 pr-4 py-2.5 rounded-lg border outline-none transition-all ${
                      errors.telefonePrincipal ? 'border-red-300 focus:border-red-500 focus:ring-2 focus:ring-red-500/20' : 'border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20'
                    }`}
