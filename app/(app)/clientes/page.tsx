  ...
  return (
    <div>
      ...
      <form className="card p-4 mb-6 flex flex-wrap gap-3 items-end">
        ...
        <Link href="/clientes" className="btn-secondary">Limpar</Link>
      </form>
        ...
        <div className="card overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                <th className="text-left font-medium text-slate-500 px-4 py-3">Código</th>
                <th className="text-left font-medium text-slate-500 px-4 py-3">Nome</th>
                <th className="text-left font-medium text-slate-500 px-4 py-3">Telefone</th>
                <th className="text-left font-medium text-slate-500 px-4 py-3">Rota</th>
                <th className="text-left font-medium text-slate-500 px-4 py-3">Cidade</th>
