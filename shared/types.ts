// Este arquivo é compartilhado com o mobile (app-cobrancas-main/src/types/index.ts)
// src/types/index.ts
// ============================================================================
...
export interface DescricaoProduto {  id: string | number;
...
export interface HistoricoCobranca extends SyncableEntity {
  ...
  // Percentual
  percentualEmpresa: number;
  subtotalAposDescontos: number;  valorPercentual: number;
